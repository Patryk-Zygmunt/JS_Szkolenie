...
// localhost:27017 -> moviedb
declare interface _0__BaseDb extends Db {
    getSiblingDB(database: "moviedb"): _0_moviedb_;
}
declare interface _0_ {
    getDB(database: "moviedb"): _0_moviedb_;
}
declare interface _0_moviedb_ extends _0__BaseDb {
}
// localhost:27017 -> moviedb -> movies
declare interface _0_moviedb_  {
    movies: Collection_<_0_moviedb_movies_, _0_moviedb_movies_Flatten>;
    getCollection(name: "movies"): Collection_<_0_moviedb_movies_, _0_moviedb_movies_Flatten>;
}
declare interface _0_moviedb_movies_ {
    _id : ObjectId
    name : string
    description : string
    director : string
...
declare interface _0_moviedb_movies_Flatten {
    _id : ObjectId
    name : string
    description : string
    director : string
...
// localhost:27017 -> moviedb -> comments
declare interface _0_moviedb_  {
    comments: Collection_<_0_moviedb_comments_, _0_moviedb_comments_Flatten>;
    getCollection(name: "comments"): Collection_<_0_moviedb_comments_, _0_moviedb_comments_Flatten>;
}
declare interface _0_moviedb_comments_ {
    _id : ObjectId
    author : string
    content : string
    movieId : ObjectId
...
declare interface _0_moviedb_comments_Flatten {
    _id : ObjectId
    author : string
    content : string
    movieId : ObjectId
...
// localhost:27017 -> northwind_mongo
declare interface _0__BaseDb extends Db {
    getSiblingDB(database: "northwind_mongo"): _0_northwind_mongo_;
}
declare interface _0_ {
    getDB(database: "northwind_mongo"): _0_northwind_mongo_;
}
declare interface _0_northwind_mongo_ extends _0__BaseDb {
}
// localhost:27017 -> northwind_mongo -> orders
declare interface _0_northwind_mongo_  {
    orders: Collection_<_0_northwind_mongo_orders_, _0_northwind_mongo_orders_Flatten>;
    getCollection(name: "orders"): Collection_<_0_northwind_mongo_orders_, _0_northwind_mongo_orders_Flatten>;
}
declare interface _0_northwind_mongo_orders_ {
    _id : ObjectId
    orderDate : Date
    shippedDate : Date
    customerId : string
...
declare interface _0_northwind_mongo_orders_Flatten {
    _id : ObjectId
    orderDate : Date
    shippedDate : Date
    customerId : string
...
// localhost:27017 -> northwind_mongo -> products
declare interface _0_northwind_mongo_  {
    products: Collection_<_0_northwind_mongo_products_, _0_northwind_mongo_products_Flatten>;
    getCollection(name: "products"): Collection_<_0_northwind_mongo_products_, _0_northwind_mongo_products_Flatten>;
}
declare interface _0_northwind_mongo_products_ {
    _id : number
    name : string
    unitPrice : number
    unitsInStock : number
...
declare interface _0_northwind_mongo_products_Flatten {
    _id : number
    name : string
    unitPrice : number
    unitsInStock : number
...
// localhost:27017 -> northwind_mongo -> customers
declare interface _0_northwind_mongo_  {
    customers: Collection_<_0_northwind_mongo_customers_, _0_northwind_mongo_customers_Flatten>;
    getCollection(name: "customers"): Collection_<_0_northwind_mongo_customers_, _0_northwind_mongo_customers_Flatten>;
}
declare interface _0_northwind_mongo_customers_ {
    _id : string
    companyName : string
    contact : 
{
...
declare interface _0_northwind_mongo_customers_Flatten {
    _id : string
    companyName : string
    contact : any
    "contact.name" : string
